...
class PlatformTextFormField extends PlatformWidgetBase<
    CupertinoTextFormFieldRow, TextFormField, fluent_ui.TextFormBox> {
  final Key? widgetKey;
  final TextEditingController? controller;
  final String? initialValue;
  final FocusNode? focusNode;
  ...
  final PlatformBuilder<FluentTextFormFieldData>? fluent;
  ...
  @override
  fluent_ui.TextFormBox createFluentWidget(fluent_ui.BuildContext context) {
    final data = fluent?.call(context, platform(context));

    return fluent_ui.TextFormBox(
      key: data?.widgetKey ?? widgetKey,
      controller: data?.controller ?? controller,
      header: data?.header,
      initialValue: data?.initialValue ?? initialValue,
